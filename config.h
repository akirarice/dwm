...
static Key keys[] = {
	...
	{ SUPER|ShiftMask,		XK_b,	   spawn,	   SHCMD("firefox --private-window") },
	...
	{ SUPER,			XK_Right,  spawn,	   SHCMD("mpc next & dwm_mpc") },
	{ SUPER,			XK_Left,   spawn,	   SHCMD("mpc prev & dwm_mpc") },
	{ SUPER,			XK_Down,   spawn,	   SHCMD("mpc toggle & dwm_mpc") },
	...
	{ 0, XF86XK_AudioPrev,		spawn,		SHCMD("mpc prev & dwm_mpc") },
	{ 0, XF86XK_AudioNext,		spawn,		SHCMD("mpc next & dwm_mpc") },
	{ 0, XF86XK_AudioPause,		spawn,		SHCMD("mpc pause & dwm_mpc") },
	{ 0, XF86XK_AudioPlay,		spawn,		SHCMD("mpc toggle & dwm_mpc") },
